...
var Record = function () {
    var _init = function () {
     ...
     // doc.styles.tableHeader.alignment = 'center';
                                ...
                                <div class = "dropdown dropdown-inline">\
                                    ...
                                    <div class = "dropdown-menu dropdown-menu-sm dropdown-menu-right">\
                                        <ul class = "nav nav-hoverable flex-column">\
                                            <li class = "nav-item">\
                                                <a href="javascript:;" data-id="'+row.id+'" class="nav-link validate-record">\
        ...
        myGlyph.src = BASE_URL+'dist/assets/media/img/city-logo.png';
        ...
        $(document).on('click', '.validate-record', function(e){
            e.preventDefault();
            id = $(this).data('id')
            Swal.fire({
                title: "Oooppss!",
