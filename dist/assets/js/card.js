...
var Proceed = function () {
    var _init = function () {  
        ...
        validation = FormValidation.formValidation(
            KTUtil.getById("searh-person-form"),
            {
                fields: {
                    id: {
                        validators: {
        ...
        $('#search-person-btn').on('click', function (e) {
            e.preventDefault(); 
            ...
            validation.validate().then(function(status) {
                ...
                if (status == 'Valid') {
                    console.info(status)
                    window.location.href = BASE_URL + 'card/release/' + $('input[name="id"]').val();
                    // $.ajax({
                    //     url: $("#add-vaccinated-form").attr('action'),
                    //     method: $("#add-vaccinated-form").attr('method'),
                    //     data: $("#add-vaccinated-form").serialize(),
                    //     dataType: "json",
                    //     beforeSend: function () {
                    //         KTApp.block('body', {
                    //             overlayColor: '#000000',
