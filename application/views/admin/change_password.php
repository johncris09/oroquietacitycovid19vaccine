...
<html lang="en">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							<div class="container">
								...
								<form id="change-password-form"  action="<?php echo base_url() ?>user/update_password/<?php echo $user['user_id']; ?>" method="post"  enctype="multipart/form-data">
									<div class="card card-custom gutter-b">
										...
										<div class="card-body">
											<div class="form-group row"> 
												<label class="col-lg-3 col-xl-3 col-sm-3 col-md-3 col-4 col-form-label">Current Password<span class="text-danger">*</span> </label>
											...
											<div class="form-group row"> 
												...
												<div class="col-lg-9 col-xl-9 col-sm-9 col-md-9 col-8">
													<div class="input-group">
														<input type="password"pattern=".{8,}" class="form-control" name="new_password" placeholder="Password" autocomplete="off"/>
														<div class="input-group-append"  style="cursor: pointer;">
															<span class="input-group-text"> <i class="far fa-eye show-password"></i> </span>
														</div>
													</div>
											...
											<div class="form-group row"> 
												...
												<div class="col-lg-9 col-xl-9 col-sm-9 col-md-9 col-8">
													<div class="input-group">
														<input type="password"pattern=".{8,}" class="form-control" name="confirm_password" placeholder="Confirm Password" autocomplete="off"/>
														<div class="input-group-append"  style="cursor: pointer;">
															<span class="input-group-text"> <i class="far fa-eye show-password"></i> </span>
														</div>
													</div>
										...
										<div class="card-footer">
											<div class="text-right">
												...
												<button type="submit" id="change-password-btn" class="btn btn-primary"> <i class="fas fa-save"></i> Change</button>
	...
	<script src="<?php echo base_url(); ?>dist/assets/js/change_password.js"></script> 
