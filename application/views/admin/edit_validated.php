...
<html lang="en">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							<div class="container">
								...
								<form id="update-validated-form"  action="<?php echo base_url() ?>validated/update/<?php echo $validated['id']; ?>" method="post"  enctype="multipart/form-data">
									<div class="card card-custom gutter-b">
											...
											<div id="personal-information">
												<div class="form-group row">
													<div class="12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														...
														<input type="text" name="lastname" value="<?php echo ucwords($validated['lastname']); ?>" class="form-control input-sm" placeholder="Last Name" />
													</div>
													<div class="12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														<label>First Name<span class="text-danger">*</span></label>
														<input type="text" name="firstname" value="<?php echo ucwords($validated['firstname']); ?>" class="form-control input-sm" placeholder="First Name" />
													</div>
													<div class="12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														<label>Middle Name</label>
														<input type="text" name="middlename" value="<?php echo ucwords($validated['middlename']); ?>" class="form-control input-sm" placeholder="Middle Name" />
													</div>
													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														<label>Gender<span class="text-danger">*</span></label>
														<div class="radio-inline">
															<label class="radio radio-square">
															<input type="radio" name="gender" <?php echo ucwords($validated['gender']) == "Male"  ? "checked='checked'" : "" ?> value="Male"    />
															<span></span>M</label>
															<label class="radio radio-square">
															<input type="radio" name="gender"  <?php echo ucwords($validated['gender']) == "Female"  ? "checked='checked'" : "" ?>  value="Female"    />
															<span></span>F</label>
														</div>
													</div>
												</div>
												<div class="form-group row">
														...
														<select name="purok" class="form-control" >
															...
															<?php 
																foreach ($this->config->item('purok') as $row) {
																	$selected = ($row == $validated['purok']) ? 'selected="selected"' : '' ; 
																	echo '
													...
													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														...
														<input type="text" class="form-control input-sm" value="<?php echo ucwords($validated['street']); ?>" name="street" placeholder="Street" />
													</div>
													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														...
														<select name="barangay" class="form-control" >
															...
															foreach ($this->config->item('barangay') as $row) {
																	$selected = ($row == $validated['barangay']) ? 'selected="selected"' : '' ; 
																echo '
																	<option value="'.$row.'"  '.$selected.' >'.$row.'</option>';
															}
															?>
													...
													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														...
														<input type="text" class="form-control input-sm" name="contactnumber"  value="<?php echo ucwords($validated['contactnumber']); ?>"  placeholder="Contac #" />
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
														<?php
															$birthDate = date('m/d/Y', strtotime($validated['birthdate']));
													...
													<div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
														...
														<select name="occupation" class="form-control" >
															...
															foreach ($this->config->item('occupation') as $row) {
																$selected = ($row == $validated['occupation']) ? 'selected="selected"' : '' ; 
																echo '
																	<option value="'.$row.'" '.$selected.' >'.$row.'</option>';
															}
															?>
												...
												<div class="form-group row"> 
													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														...
														<div class="radio-inline">
															<label class="radio radio-square">
															<input type="radio" name="registeredvoter"  <?php echo ucwords($validated['registeredvoter']) == "1"  ? "checked='checked'" : "" ?> value="1"    />
															<span></span>Yes</label>
															<label class="radio radio-square">
															<input type="radio" name="registeredvoter"   <?php echo ucwords($validated['registeredvoter']) == "0"  ? "checked='checked'" : "" ?>   value="0"    />
															<span></span>No</label>
														</div> 
													</div>
													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														...
														<select name="governmentissuedid" class="form-control" >
															...
															foreach ($this->config->item('government_id') as $row) {
																$selected = ($row == $validated['governmentissuedid']) ? 'selected="selected"' : '' ; 
																echo '
																	<option value="'.$row.'" '.$selected.' >'.$row.'</option>';
															}
															?>
													...
													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														...
														<input type="text" class="form-control input-sm" name="idnumber"  value="<?php echo ucwords($validated['idnumber']); ?>"  placeholder="ID Number" autocomplete="off" />
													</div>

													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
														<label class="text-sm">Date Registered<span class="text-danger">*</span></label>
														<input type="text"  value="<?php echo date('m/d/Y', strtotime($validated['date_registered'])); ?>" id="date-registered" class="form-control input-sm"  name="date_registered"  autocomplete="off" />
													</div>
												</div>
											</div>
												...
												foreach ($medical_history as $row) {
													if($row['multiple_choice']){
																...
																foreach ($row['choices'] as $choice) {
																	foreach ($choice as  $chk) {
																		if($row['optname'] == 'OptionIllness_1[]'){
																			$illness = explode(',', $validated['optionIllness_1']);
																			...
																			$illness = explode(',', $validated['optionIllness_2']);
																			$illness = array_map('trim', $illness);
																			$checked =   in_array($chk['value'], $illness) ? 'checked="checked"' :'';
														...
														if($row['optname'] == "OptionIllness_2[]"){
															if( !empty($validated['other_illness']) || is_null( $validated['other_illness'] ) ){
															...
															echo '
																<div class="col-6 col-form-label ">
																	<div class="checkbox-list">
																		...
																		<input class="form-control float-right" type="text" name="other_illness" value="'.$validated['other_illness'].'" id="other-illness" />
																	</div>
																</div> 
													...
													echo '
																...
																<div class="d-flex flex-row">
																	...
																	foreach ($row['choices'] as $choice) {
																		foreach ($choice as  $opt) {
																			$checked =  $validated[strtolower($row['txtname'])] == $opt['value'] ? 'checked="checked"' :'';
																			echo '
																	            <label class="radio radio-square">
														...
														echo '
																		<input type="hidden"  name="'.$row['txtname'].'" value="'.$validated[strtolower($row['txtname'])].'">
																	</div>
																</div>
															</div>';
													}
										...
										<div class="card-footer">
											<div class="text-right">
												...
												<button type="button" id="update-validated-btn" class="btn btn-primary"> <i class="fas fa-save"></i> Update</button>
	...
	<script src="<?php echo base_url(); ?>dist/assets/js/edit_validated.js"></script> 
