									...
									<div class="card card-custom gutter-b">
										...
										<div class="card-body">  
											<div class="form-group row">
												<label class="col-3 col-form-label">Last Name<span class="text-danger">*</span> </label>
												<div class="col-9">
													<input class="form-control input-sm" type="text" name="lastname" placeholder="Last Name" autocomplete="off" autofocus="" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-3 col-form-label">First Name<span class="text-danger">*</span> </label>
												<div class="col-9">
											...
											<div class="form-group row">
												<label class="col-3 col-form-label">Username<span class="text-danger">*</span> </label>
												<div class="col-9">
