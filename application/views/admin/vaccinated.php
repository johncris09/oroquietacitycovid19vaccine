...
<html lang="en">
								...
								<div class="card card-custom gutter-b">
									<div class="card-header py-3">
										...
										<div class="card-toolbar"> 
											<a href="<?php echo base_url(); ?>vaccinated/add"  class="btn btn-primary font-weight-bolder">
									...
									<div class="card-body">
										...
										<table class="table table-striped table-sm table-responsive table-bordered table-hover table-checkable dt-responsive nowrap"  id="vaccinated-table">
											<thead>
												<tr>
													<th></th>
													<th>#</th>
	...
	<script src="<?php echo base_url(); ?>dist/assets/js/vaccinated.js"></script> 
