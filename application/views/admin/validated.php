...
<html lang="en">
							...
							<div class="container">  
								<div class="card card-custom gutter-b">
									...
									<div class="card-body"> 
										...
										<table class="table table-striped table-sm  table-bordered table-hover table-checkable cell-border compact stripe nowrap"  id="validated-table">
											<thead>
												<tr>
													<th></th>
													<th>Action</th>
	...
	<script src="<?php echo base_url(); ?>dist/assets/js/validated.js"></script> 
