...
class Dashboard extends CI_Controller { 
    ...
    public function barangay_chart()
    {
        ...
        //     foreach ($this->config->item('barangay') as $barangay) {
        ...
        //     // while (strtotime($start_date) <= strtotime($end_date)) {
        //     //     $date = $start_date;
        //     //     $record = $this->record_model->barangay_record_this_month($date, $barangay); 
        //     //     if(!empty($record)){
        //     //         $data['pre_registered'][]       = $record[0]['tot'];
        //     //         $data['categories'][]           = date('d', strtotime($date));
        //     //     }else{
        ...
        //     //     // $validated = $this->validated_model->barangay_validated_this_month($date); 
        //     //     // if(!empty($validated)){
        //     //     //     $data['validated'][]        = $validated[0]['tot'];
        //     //     // }else{
        //     //     //     $data['validated'][]        = 0;
